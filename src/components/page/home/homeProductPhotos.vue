    ...
    return {
      productPhotos: [
        ...
        },
        {
          'name': 'Autodesk',
          'id': '2-2',
          'photoUrl': require('../../../assets/img/homeproductPhotos/autodesk.png'),
          'alt': 'Autodesk',
          'desc': 'Autodesk'
        },
        {
          'name': 'Microsoft',
          'id': '2-3',
          'photoUrl': require('../../../assets/img/homeproductPhotos/Microsoft.png'),
          'alt': 'Microsoft',
          'desc': 'Microsoft'
        },
        {
...
<style scoped>
@import "../../../assets/css/home/homeProductPhotos.css";
</style>
